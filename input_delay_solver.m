...
% described in the Scale-free input delay paper. Specifically, the linear 
% system is solved, and synchronization of the agents is achieved. If the 
% given C is the identity, full-state coupling is implemented. Otherwise, 
% the protocol for  partial-state coupling is enacted. The core solver used
